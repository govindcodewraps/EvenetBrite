            ...
            children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                alignment: Alignment.center,
                                child: Text("${bookrealEstateController.count}",
                                    style: TextStyle(
                                        color: notifire.getwhiteblackcolor)),
                              ),
                            ),
                            InkWell(
                              onTap: () {
                                if (bookrealEstateController.count <
                                    int.parse(reviewSummaryController.plimit)) {
                                  setState(() {
                                    bookrealEstateController.count++;
                                  });
                                }
              ...
              GestButton(
                ...
                onclick: () {
                  ...
                  // if (bookrealEstateController.visible == true) {
                  //   if (bookrealEstateController.chack == true) {
                  //     Get.toNamed(Routes.bookInformetionScreen);
                  //   } else {
                  //     Get.toNamed(Routes.reviewSummaryScreen);
                  //   }
                  //   // } else {
                  //   //   Fluttertoast.showToast(
                  //   //     msg: bookrealEstateController.checkDateMsg,
