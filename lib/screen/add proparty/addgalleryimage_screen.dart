                  ...
                  children: [
                    ...
                    GetBuilder<GalleryImageController>(builder: (context) {
                      return Container(
                        ...
                        child: DropdownButton(
                          dropdownColor: notifire.getbgcolor,
                          hint: galleryImageController.selectGalleryCat.isEmpty
                              ? Text(
                                  "No Data Found".tr,
                                  style: TextStyle(color: Colors.grey),
                                )
                          ...
                          value: galleryImageController.slectStatus,
                          icon: Image.asset(
                            'assets/images/Arrow - Down.png',
                            height: 20,
                            width: 20,
                          ...
                          isExpanded: true,
                          underline: SizedBox.shrink(),
                          items: galleryImageController.selectGalleryCat
                              .map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(
                          ...
                          onChanged: (value) {
                            for (var i = 0;
                                i <
                                    galleryImageController
                                        .propertyWiseInfo!.galcatlist.length;
                                i++) {
                              if (value ==
                                  galleryImageController.propertyWiseInfo!
                                      .galcatlist[i].catTitle) {
                            ...
                            setState(() {
                              galleryImageController.slectStatus = value ?? "";
                              // listOfUser.add(selectValue);
                            });
                          },
                        ),
