                ...
                child: Row(
                  children: [
                    ...
                    GetBuilder<AddPropertiesController>(builder: (context) {
                      return manegeRoute == "edit"
                          ? addPropertiesController.buyOrRent == "1"
                              ? SizedBox()
                              : addPropertiesController.buyOrRent == "2"
                                  ? addPropertiesController.pShell != "1"
                                      ? InkWell(
                                          onTap: () {
                                            enquriryController
                                                .makeSellPropertyApi(
                                              Id: addPropertiesController.Id,
                                            );
                                          },
                                          child: Container(
                                            height: 31,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton(
                            ...
                            // validator: (value) {
                            //   if (value == null || value.isEmpty) {
                            //     return 'Please Add Property Type';
                            //   }
                            //   return null;
                            // },
