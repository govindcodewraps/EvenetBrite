...
class Config {
  ...
  static const String baseurl = 'https://hotelbooking.codewraps.in/';
  static const String notificationUrl = 'https://fcm.googleapis.com/fcm/send';
  static const String firebaseKey = 'AIzaSyChHJbN8ciy_y_hWSBas2UBC__VOTIMQhI';
  static const String path = baseurl + '/user_api/';
  static const String oneSignel = "********************************";
  static const googleKey = "AIzaSyB4TzkR8r5hqAveLhajOq5uqvYGV1SSkxY";
